...
VALUES
    ('Mahabaleshwar & Western Ghats Valley Retreat', 'Mahabaleshwar, Maharashtra', 'Hill Station', 'https://images.unsplash.com/photo-1596401057633-54a8fe8ef647?auto=format&fit=crop&w=800&q=80', 'Family holiday booked from Pune. Clean Ertiga, smooth drive through Pasarni Ghat and fresh strawberry farm tour.', 'Pawar Family, Pune', 5),
    ('Divine Shirdi Sai Baba & Historic Forts Tour', 'Shirdi & Pune, Maharashtra', 'Spiritual', 'https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?auto=format&fit=crop&w=800&q=80', 'Same-day return yatra from Pune. On-time 5 AM pickup, VIP darshan assistance, and comfortable AC sedan drive.', 'Suresh & Meena Deshmukh, Kothrud', 5),
    ('Sunrise Marvel at the Taj Mahal', 'Agra, Uttar Pradesh', 'Heritage', 'https://images.unsplash.com/photo-1564507592333-c60657eea523?auto=format&fit=crop&w=800&q=80', 'Chauffeur picked us up early morning. Fast Yamuna Expressway drive, seamless guide arrangement and royal monument tour.', 'Vikram & Ananya Malhotra, Delhi', 5),
    ('Sacred Ganga Aarti & Kashi Vishwanath Yatra', 'Varanasi, Uttar Pradesh', 'Spiritual', 'https://images.unsplash.com/photo-1561361513-2d000a50f0dc?auto=format&fit=crop&w=800&q=80', 'Magnificent evening Dashashwamedh Ghat aarti with boat ride. The chauffeur escorted our senior parents patiently.', 'Rameshwar Kulkarni, Pune', 5),
    ('Majestic Gwalior Fort & Scindia Palace Circuit', 'Gwalior, Madhya Pradesh', 'Heritage', 'https://images.unsplash.com/photo-1627894483216-2138af692e32?auto=format&fit=crop&w=800&q=80', 'Imposing hill fortress known as the Pearl among fortresses in India. Super comfortable Innova Crysta for our Madhya Pradesh heritage circuit.', 'Dr. Arvind & Neha Saxena, Bhopal', 5),
    ('Holy Mahakaleshwar & Shipra River Yatra', 'Ujjain, Madhya Pradesh', 'Spiritual', 'https://images.unsplash.com/photo-1609766857041-ed402ea8069a?auto=format&fit=crop&w=800&q=80', 'Peaceful pilgrimage covering Mahakal temple and Ram Ghat. Chauffeur ensured timely reporting for the sacred Bhasma Aarti.', 'Gupta Family, Indore', 5),
    ('Tirumala Venkateswara Swamy Pilgrimage', 'Tirupati, Andhra Pradesh', 'Spiritual', 'https://images.unsplash.com/photo-1582510003544-4d00b7f74220?auto=format&fit=crop&w=800&q=80', 'Soulful darshan of Lord Balaji. Dedicated cab took us smoothly across the Tirumala ghat roads and back.', 'Kalyan & Sunitha Reddy, Hyderabad', 5),
    ('Misty Araku Valley & Eastern Ghats Drive', 'Araku Valley, Andhra Pradesh', 'Hill Station', 'https://images.unsplash.com/photo-1589182373726-e4f658ab50f0?auto=format&fit=crop&w=800&q=80', 'Serene Eastern Ghats drive from Vizag to Araku Valley. Spectacular Million-year-old Borra caves and fresh coffee plantations.', 'Aditya, Rohit & Batchmates', 5),
    ('Grand Statue of Unity & Valley of Flowers Tour', 'Kevadia, Gujarat', 'Heritage', 'https://images.unsplash.com/photo-1585130401366-fe05a8d813c4?auto=format&fit=crop&w=800&q=80', 'Monumental 182-meter statue experience. Our Innova was prompt, AC was powerful, and laser light show was unforgettable.', 'Patel Family, Ahmedabad', 5),
    ('Enchanting White Rann Full-Moon Safari', 'Rann of Kutch, Gujarat', 'Heritage', 'https://images.unsplash.com/photo-1609840114035-3c981b782dfe?auto=format&fit=crop&w=800&q=80', 'Full-moon glow across the vast white salt desert and colorful Kutchi handicraft shopping in Dhordo village.', 'Nitin & Bhavna Shah, Surat', 5),
    ('Capital Heritage: Qutub Minar & Mughal Monuments', 'New Delhi, Delhi', 'Heritage', 'https://images.unsplash.com/photo-1587474260584-136574528ed5?auto=format&fit=crop&w=800&q=80', 'Full-day Delhi sightseeing covering India Gate, Qutub Minar, and Humayun Tomb. The chauffeur knew every shortcut avoiding traffic.', 'Sarah & Mark (UK Travelers)', 5),
    ('Red Fort Splendor & Chandni Chowk Delights', 'Old Delhi, Delhi', 'Heritage', 'https://images.unsplash.com/photo-1598324789736-4861f89564a0?auto=format&fit=crop&w=800&q=80', 'Iconic 17th-century Mughal red sandstone fort followed by legendary parathas in Chandni Chowk. Top notch cab service.', 'Kapoor Family, Gurgaon', 5);
